...
public class EnricherPlugin : IPlugin
{
    ...
    {
        _logger.LogDebugWithHierarchy(context, "Parsing input compressed file cache data array from StandardizerPlugin");
        ...
        try
        {
            ...
            _logger.LogInformationWithHierarchy(context, "Successfully parsed cache data array with {ItemCount} items", jsonArray.Length);
